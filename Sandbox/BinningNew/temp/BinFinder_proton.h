...
// Mon Feb 11 09:07:38 2019 by ROOT version 6.06/08
...
#ifndef BinFinder_proton_h
#define BinFinder_proton_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   BinFinder_proton(TTree *tree=0);
   virtual ~BinFinder_proton();
...
#ifdef BinFinder_proton_cxx
BinFinder_proton::BinFinder_proton(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/uboone/data/users/jiangl/ubxsec_static/v06_26_01_22_Feb/ubxsecana_output_mc_bnbcosmic_ubcodev06_26_01_22.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/uboone/data/users/jiangl/ubxsec_static/v06_26_01_22_Feb/ubxsecana_output_mc_bnbcosmic_ubcodev06_26_01_22.root");
      }
...
BinFinder_proton::~BinFinder_proton()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t BinFinder_proton::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t BinFinder_proton::LoadTree(Long64_t entry)
{
...
void BinFinder_proton::Init(TTree *tree)
{
...
Bool_t BinFinder_proton::Notify()
{
...
void BinFinder_proton::Show(Long64_t entry)
{
...
Int_t BinFinder_proton::Cut(Long64_t entry)
{
...
#endif // #ifdef BinFinder_proton_cxx
