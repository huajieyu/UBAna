...
// Tue Mar 19 15:41:16 2019 by ROOT version 6.06/08
// from TTree true_reco_tree/true_reco_tree
// found on file: /uboone/data/users/jiangl/ubxsec_static/v06_26_01_22_Feb/ubxsecana_output_mc_bnbcosmic_ubcodev06_26_01_22_detsyst_CV.root
//////////////////////////////////////////////////////////
...
#ifdef RewgtFac_cxx
RewgtFac::RewgtFac(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/uboone/data/users/jiangl/ubxsec_static/v06_26_01_22_Feb/ubxsecana_output_mc_bnbcosmic_ubcodev06_26_01_22_detsyst_CV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/uboone/data/users/jiangl/ubxsec_static/v06_26_01_22_Feb/ubxsecana_output_mc_bnbcosmic_ubcodev06_26_01_22_detsyst_CV.root");
      }
...
Int_t RewgtFac::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t RewgtFac::LoadTree(Long64_t entry)
{
...
void RewgtFac::Show(Long64_t entry)
{
...
Int_t RewgtFac::Cut(Long64_t entry)
{
