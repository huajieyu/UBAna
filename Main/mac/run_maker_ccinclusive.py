...
maker.SetInputFile("/uboone/data/users/kirby/cc1muNp_ubxsec_ntuples/ntuples_Jan27_merge/ubxsec_output_mc_bnbcosmic.root");
maker.SetOutputFile("/uboone/data/users/jiangl/ubxsec_static/v06_26_01_22_Feb10/ubxsecana_output_mc_bnbcosmic_ubcodev06_26_01_22.root") # Run1 After Neutrino

# BNB DIRT Sample
#maker.SetInputFile("/uboone/data/users/kirby/cc1muNp_ubxsec_ntuples/ntuples_Jan27_merge/ubxsec_output_mc_dirt.root");
#maker.SetOutputFile("/uboone/data/users/jiangl/ubxsec_static/v06_26_01_22_Feb10/ubxsecana_output_mc_bnbdirt_ubcodev06_26_01_22.root");
