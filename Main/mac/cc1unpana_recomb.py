...
#analyser.SetBNBCosmicFile("/uboone/data/users/jiangl/ubxsec_static/v06_26_01_22_Apr25/ubxsecana_output_mc_bnbcosmic_ubcodev06_26_01_22_detsyst_CV.root") # tune 1
...
for sample in samples:
  analyser.SetEXTBNBFile("/uboone/data/users/afurmans/recombinationUncertainty_UBAna_files/ubxsecana_output_data_offbeam_recomb_"+sample+".root")
  analyser.SetBNBONFile("/uboone/data/users/afurmans/recombinationUncertainty_UBAna_files/ubxsecana_output_data_onbeam_recomb_"+sample+".root")
  analyser.SetPrefix("recombination_"+sample);
