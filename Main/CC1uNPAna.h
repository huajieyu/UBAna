 ...
 * \ingroup Main
 * 
 * \brief Class def header for a class CC1uNPAna
 *
 * @author deltutto
 */
...
/** \addtogroup Main
    ...
    @{*/
#ifndef __MAIN_CC1uNPAna_H__
#define __MAIN_CC1uNPAna_H__
...
namespace Main {
  ...
  /**
     \class CC1uNPAna
     User defined class CC1uNPAna ... these comments are used to generate
     doxygen documentation!
  */
  class CC1uNPAna : public LoggerFeature {
    
  public:
    
    /// Default constructor
    CC1uNPAna(std::string name = "CC1uNPAna") 
    : LoggerFeature(name) {}
  ...
  private:
    ...
    bool _do_pm1sigma_xsec_plots = true;
