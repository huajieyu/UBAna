...
void plot_uncertainty(){
  ...
  int n_bins_testp = 11;
    ...
    stat_mumom=new TH1D("stat_mumom", "stat_mumom", n_bins_mumom, bins_mumom);
    stat_mumom->SetLineWidth(4);
    stat_pmom=new TH1D("stat_pmom", "stat_pmom", n_bins_pmom, bins_pmom);
    stat_pmom->SetLineWidth(4);
    stat_muangle=new TH1D("stat_mucostheta", "stat_mucostheta", n_bins_mucostheta, bins_mucostheta);
    stat_muangle->SetLineWidth(4);
    stat_pangle=new TH1D("stat_pcostheta", "stat_pcostheta", n_bins_pcostheta, bins_pcostheta);
    stat_pangle->SetLineWidth(4);
    stat_thetamup=new TH1D("stat_muptheta", "stat_muptheta", n_bins_muptheta, bins_muptheta);
    stat_thetamup->SetLineWidth(4);
    ...
    TFile *xsec_inputfile= new TFile("xsec_file_CV_Tune1.root");
    ...
    for(int j=0; j<stat_mumom->GetNbinsX(); j++){
         stat_mumom->SetBinContent(j+1, xsec_mumom_CV->GetBinError(j+1)/xsec_mumom_CV->GetBinContent(j+1));
    }
    for(int j=0; j<stat_pmom->GetNbinsX(); j++){
         stat_pmom->SetBinContent(j+1, xsec_pmom_CV->GetBinError(j+1)/xsec_pmom_CV->GetBinContent(j+1));
    }
    for(int j=0; j<stat_muangle->GetNbinsX(); j++){
         stat_muangle->SetBinContent(j+1, xsec_muangle_CV->GetBinError(j+1)/xsec_muangle_CV->GetBinContent(j+1));
    }
    for(int j=0; j<stat_pangle->GetNbinsX(); j++){
         stat_pangle->SetBinContent(j+1, xsec_pangle_CV->GetBinError(j+1)/xsec_pangle_CV->GetBinContent(j+1));
    }
    for(int j=0; j<stat_thetamup->GetNbinsX(); j++){
         stat_thetamup->SetBinContent(j+1, xsec_thetamup_CV->GetBinError(j+1)/xsec_thetamup_CV->GetBinContent(j+1));
    }

 
    TLegend * leg=new TLegend(0.6, 0.7, 0.9, 0.9); 
    for(int i=0; i<syst_unc_type.size(); i++){
       if(i<syst_unc_type.size()-1){
       ...
       Total_Thetamup_9999[i]=(TH1D*)inputfile[i]->Get("Total_Thetamup_9999");
            ...
            Total_Muon_Momentum_9999[i]=(TH1D*)stat_mumom->Clone();
            Total_Proton_Momentum_9999[i]=(TH1D*)stat_pmom->Clone();
            Total_Muon_CosTheta_9999[i]=(TH1D*)stat_muangle->Clone();
            Total_Proton_CosTheta_9999[i]=(TH1D*)stat_pangle->Clone();
            Total_Thetamup_9999[i]=(TH1D*)stat_thetamup->Clone();
       } 
       ...
       for(int j=0; j<nbins; j++){
         total_thetamup_1->SetBinContent(j+1, total_thetamup_1->GetBinContent(j+1) + Total_Thetamup_9999[i]->GetBinContent(j+1)*Total_Thetamup_9999[i]->GetBinContent(j+1)); 
       }
       ...
       if(i+2==7) Total_Muon_Momentum_9999[i]->SetLineColor(9); 
       ...
       if(i+2==7) Total_Proton_Momentum_9999[i]->SetLineColor(9); 
       ...
       if(i+2==7) Total_Muon_CosTheta_9999[i]->SetLineColor(9); 
       ...
       if(i+2==7) Total_Proton_CosTheta_9999[i]->SetLineColor(9); 
       ...
       if(i+2==7) Total_Thetamup_9999[i]->SetLineColor(9); 
  ...
  TFile *xsec_tune3_inputfile= new TFile("xsec_file_CV_Tune3.root");

  
  TH1D * xsec_tune3_mumom_mc;
  TH1D * xsec_tune3_mumom_CV;
  TH1D * xsec_tune3_pmom_mc;
  TH1D * xsec_tune3_pmom_CV;
  TH1D * xsec_tune3_muangle_mc;
  TH1D * xsec_tune3_muangle_CV;
  TH1D * xsec_tune3_pangle_mc;
  TH1D * xsec_tune3_pangle_CV;
  TH1D * xsec_tune3_thetamup_mc;
  TH1D * xsec_tune3_thetamup_CV;
   

  //=======================================================================
  xsec_tune3_mumom_mc=(TH1D*)xsec_tune3_inputfile->Get("xsec_mumom_mc_CV");
  xsec_tune3_mumom_CV=(TH1D*)xsec_tune3_inputfile->Get("xsec_mumom_CV");

  xsec_tune3_pmom_mc=(TH1D*)xsec_tune3_inputfile->Get("xsec_pmom_mc_CV");
  xsec_tune3_pmom_CV=(TH1D*)xsec_tune3_inputfile->Get("xsec_pmom_CV");

  xsec_tune3_muangle_mc=(TH1D*)xsec_tune3_inputfile->Get("xsec_muangle_mc_CV");
  xsec_tune3_muangle_CV=(TH1D*)xsec_tune3_inputfile->Get("xsec_muangle_CV");

  xsec_tune3_pangle_mc=(TH1D*)xsec_tune3_inputfile->Get("xsec_pangle_mc_CV");
  xsec_tune3_pangle_CV=(TH1D*)xsec_tune3_inputfile->Get("xsec_pangle_CV");

  xsec_tune3_thetamup_mc=(TH1D*)xsec_tune3_inputfile->Get("xsec_thetamup_mc_CV");
  xsec_tune3_thetamup_CV=(TH1D*)xsec_tune3_inputfile->Get("xsec_thetamup_CV");



  TLegend *legnew=new TLegend(0.65, 0.7, 0.9, 0.9);
  legnew->AddEntry(xsec_mumom_mc, "GENIE-default");
  //legnew->AddEntry(xsec_tune3_mumom_mc, "GENIE-Tune3");
  ...
  //==============================================================================   
   ...
   /*xsec_tune3_mumom_CV->SetLineColor(kRed);
   xsec_tune3_mumom_CV->SetFillColor(kRed-7);
   xsec_tune3_mumom_CV->Draw("E1, same");*/
   legnew->Draw("same");
   ...
   /*xsec_tune3_pmom_mc->SetLineColor(kRed);
   xsec_tune3_pmom_mc->SetFillColor(kRed-7);
   xsec_tune3_pmom_mc->Draw("E1, same");*/
   legnew->Draw("same");
   ...
   /*xsec_tune3_muangle_mc->SetLineColor(kRed);
   xsec_tune3_muangle_mc->SetFillColor(kRed-7);
   xsec_tune3_muangle_mc->Draw("E1, same");*/
   legnew->Draw("same");
   ...
   /*xsec_tune3_pangle_mc->SetLineColor(kRed);
   xsec_tune3_pangle_mc->SetFillColor(kRed-7);
   xsec_tune3_pangle_mc->Draw("E1, same");*/
   legnew->Draw("same");
   ...
   /*xsec_tune3_thetamup_mc->SetLineColor(kRed);
   xsec_tune3_thetamup_mc->SetFillColor(kRed-7);
   xsec_tune3_thetamup_mc->Draw("E1, same");
   */
   legnew->Draw("same");
